...
<div class="row mt-2">
    <?php echo $__env->make('formularios.tiposPessoasFormulario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="col-md-6">
    ...
    <div class="col-md-3">
        ...
        <select class="form-control modal_estado" id="modal_estado" name="estado">
            ...
            <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($estado['id']); ?>"><?php echo e($estado['estado']); ?>
...
<?php /**PATH C:\juridico\resources\views\formularios\clientesFormularioClientes.blade.php ENDPATH**/ ?>