                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control" id="ativo" name="ativo">
                                            <option value="A" <?php echo e($request->input('ativo') == 'A' ? 'selected' : ''); ?>>Ativo</option>
                                            <option value="I" <?php echo e($request->input('ativo') == 'I' ? 'selected' : ''); ?>>Inativo</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1">
...
<?php /**PATH C:\juridico\resources\views\tecnicos.blade.php ENDPATH**/ ?>