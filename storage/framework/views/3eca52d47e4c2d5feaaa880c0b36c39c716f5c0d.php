...
<?php $__env->startSection('content'); ?>
        <?php if($tela == 'alterar'): ?>
            <?php $__env->startSection('content_header'); ?>
                <div class="form-group row">
                    <h1 class="m-0 text-dark col-sm-9 col-form-label">Alteração de <?php echo e($nome_tela); ?></h1>
                    <div class="col-sm-3 text-right">
                        <a href="<?php echo e(route('financeiro', ['cliente_id' => $clientes[0]->id ?? ''])); ?>" class="btn btn-outline-primary btn-sm">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/clientes.blade.php ENDPATH**/ ?>