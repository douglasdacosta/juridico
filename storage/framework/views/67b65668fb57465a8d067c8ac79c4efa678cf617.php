...
<?php $__env->startSection('content'); ?>
  ...
  <div class="right_col" role="main">
    <div class="row">
      <div class="col-lg-2 col-md-4 col-sm-6 col-12">
        <div class="small-box bg-primary">
          <div class="inner">
            <h3><?php echo e($kpis['total_processos'] ?? 0); ?></h3>
            <p>Processos</p>
          </div>
      ...
      <div class="col-lg-2 col-md-4 col-sm-6 col-12">
        <div class="small-box bg-success">
          <div class="inner">
            <h3><?php echo e($kpis['processos_ativos'] ?? 0); ?></h3>
            <p>Ativos</p>
          </div>
      ...
      <div class="col-lg-2 col-md-4 col-sm-6 col-12">
        <div class="small-box bg-danger">
          <div class="inner">
            <h3><?php echo e($kpis['processos_encerrados'] ?? 0); ?></h3>
            <p>Encerrados</p>
          </div>
      ...
      <div class="col-lg-2 col-md-4 col-sm-6 col-12">
        <div class="small-box bg-info">
          <div class="inner">
            <h3><?php echo e($kpis['total_clientes'] ?? 0); ?></h3>
            <p>Clientes</p>
          </div>
      ...
      <div class="col-lg-2 col-md-4 col-sm-6 col-12">
        <div class="small-box bg-warning">
          <div class="inner">
            <h3><?php echo e($kpis['total_andamentos'] ?? 0); ?></h3>
            <p>Andamentos</p>
          </div>
      ...
      <div class="col-lg-2 col-md-4 col-sm-6 col-12">
        <div class="small-box bg-secondary">
          <div class="inner">
            <h3><?php echo e($kpis['total_documentos'] ?? 0); ?></h3>
            <p>Documentos</p>
          </div>
      ...
      <div class="col-12">
        <div class="card bg-light">
          <div class="card-body">
            ...
            <a href="<?php echo e(route('incluir-clientes')); ?>" class="btn btn-success mr-2">
              <i class="fa fa-plus"></i> Novo Cliente
            </a>
            <a href="<?php echo e(route('incluir-processos')); ?>" class="btn btn-primary mr-2">
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <form action="<?php echo e(route('home')); ?>" method="get" class="form-horizontal form-label-left" novalidate>
        ...
        <table class="table table-striped text-center">
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = ($processos ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $processo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr>
                <th scope="row"><a href="<?php echo e(route('alterar-processos', ['id' => $processo->id])); ?>"><?php echo e($processo->id); ?></a></th>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\juridico\resources\views\home.blade.php ENDPATH**/ ?>