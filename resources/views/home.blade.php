    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-12">
        <div class="small-box bg-gradient-info">
          <div class="inner">
            <h3>R$ {{ number_format($kpisFinanceiros['a_receber_pendente'], 2, ',', '.') }}</h3>
      ...
      <div class="col-lg-3 col-md-6 col-12">
        <div class="small-box bg-gradient-success">
          <div class="inner">
            <h3>R$ {{ number_format($kpisFinanceiros['recebido_mes'], 2, ',', '.') }}</h3>
      ...
      <div class="col-lg-3 col-md-6 col-12">
        <div class="small-box bg-gradient-danger">
          <div class="inner">
            <h3>R$ {{ number_format($kpisFinanceiros['total_receber_atraso'], 2, ',', '.') }}</h3>
      ...
      <div class="col-lg-3 col-md-6 col-12">
        <div class="small-box bg-gradient-warning">
          <div class="inner">
            <h3>R$ {{ number_format($kpisFinanceiros['total_pagar_atraso'], 2, ',', '.') }}</h3>
      ...
      <div class="col-lg-3 col-12 mb-3">
        <div class="x_panel h-100">
          ...
          <div class="x_content" style="max-height: 260px; overflow-y: auto;">
              ...
              <div class="mb-2 pb-2 border-bottom">
                ...
                <div class="small text-muted">
                  ...
                  @if($compromisso->processo)
                    — {{ $compromisso->processo->numero_processo }}
                  @endif
                </div>
              </div>
            @empty
            ...
            @endforelse
            <a href="{{ route('agenda') }}" class="btn btn-link btn-sm p-0 mt-2">Ver agenda completa</a>
          </div>
        </div>
      </div>
    </div>
...
@section('js')
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      var processosPorStatus = @json($processosPorStatus);
      ...
      var fluxoMensal = @json($fluxoMensal);
